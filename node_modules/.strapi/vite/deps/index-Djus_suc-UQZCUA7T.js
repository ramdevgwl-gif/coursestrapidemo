...
import {
  ...
  toKey_default,
  toString_default
} from "./chunk-UL7RT6DF.js";
import {
  require_baseForOwn
} from "./chunk-D5GHZ2XR.js";
import {
  require_identity,
...
// node_modules/@webbycrown/advanced-fields/dist/_chunks/index-Djus_suc.mjs
...
var AdvancedColor = ({
  ...
  const initialColor = (0, import_react49.useMemo)(() => {
    const normalized = value === void 0 ? defaultValue : value;
    return normalizeHexColor(normalized);
  }, [value, defaultValue]);
  const [inputValue, setInputValue] = (0, import_react49.useState)(initialColor);
  const [validationError, setValidationError] = (0, import_react49.useState)(null);
  const [hasInteracted, setHasInteracted] = (0, import_react49.useState)(false);
  const [isPickerOpen, setIsPickerOpen] = (0, import_react49.useState)(false);
  ...
  const handleChangeFromPicker = (pickerColor2) => {
    const hex = (pickerColor2 == null ? void 0 : pickerColor2.hex) ? String(pickerColor2.hex).toUpperCase() : "";
    setInputValue(hex);
    ...
    if (onChange) {
      onChange({
        target: {
          name,
          id: name,
          type: (attribute == null ? void 0 : attribute.type) || "string",
          value: hex
        }
      });
    }
                ...
                (0, import_jsx_runtime.jsxs)(
                  "span",
                  {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime.jsx)("span", { style: { color: "#32324d", fontSize: "14px" }, children: pickerColor })
                    ]
                  }
                ),
                (0, import_jsx_runtime.jsx)("span", { style: { color: "#666" }, children: isPickerOpen ? "▲" : "▼" })
              ]
            }
          ),
          isPickerOpen && !disabled && (0, import_jsx_runtime.jsx)(
            "div",
            {
              style: {
                position: "absolute",
...
//# sourceMappingURL=index-Djus_suc-UQZCUA7T.js.map
