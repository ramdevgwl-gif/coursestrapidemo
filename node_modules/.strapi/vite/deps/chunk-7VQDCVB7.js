...
import {
  LimitsModal
} from "./chunk-DHI3K5SV.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-XE3TC6SG.js";
import {
  getStageColorByHex
} from "./chunk-J2L2IBNR.js";
import {
...
} from "./chunk-3H57UGRC.js";
import {
  useTypedSelector
} from "./chunk-7V7S7JHE.js";
import {
  ReleaseActionMenu,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-CQJFACZU.js";
import {
  useConfig,
  useTracking
} from "./chunk-DBUZ7T5H.js";
import {
  AssetSource,
  AssetType,
...
var require_stringify = __commonJS({
  "node_modules/@strapi/i18n/node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var sentinel = {};
    var stringify4 = function stringify5(object, prefix, generateArrayPrefix, commaRoundTrip, strictNullHandling, skipNulls, encoder, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
      var obj = object;
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-DT6EMKUD.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-E27IBTZB.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-PXRULLCQ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-YAL5PCAG.js");
        return {
...
var import_qs13 = __toESM(require_lib2(), 1);
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-Z3QTA2HW.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-H3I2O2B2.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-RU26BNPO.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-XY7YTURV.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-MUBLGAHQ.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-GHPOKINR.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-QY5V4WBW.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-AGDCMDT7.js");
          return {
...
//# sourceMappingURL=chunk-7VQDCVB7.js.map
