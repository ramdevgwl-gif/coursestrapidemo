...
const validateExportsOrdering = async ({
  ...
  if (pkg.exports) {
    const exports$1 = Object.entries(pkg.exports);
    for (const [expPath, exp] of exports$1) {
...
const createBuildContext = async ({
  ...
  const exports$1 = resolveConfigProperty(config.exports, parsedExports);
  ...
  const outputPaths = Object.values(exports$1).flatMap((exportEntry) => {
    return [
      exportEntry.import,
      exportEntry.require,
...
//# sourceMappingURL=createBuildContext-B2xb_9uC.js.map
