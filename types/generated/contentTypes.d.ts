...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    course_category: Schema.Attribute.Relation<
      ...
      'api::course-category.course-category'
    >;
    CourseCurriculum: Schema.Attribute.DynamicZone<['shared.curriculum']>;
    CoursePlan: Schema.Attribute.Enumeration<['Free', 'Paid']> &
    ...
    learnings: Schema.Attribute.Component<'shared.cards-section', true>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    FooterMenu1: Schema.Attribute.Component<'shared.footer-menu-1', false>;
    FooterMenu2: Schema.Attribute.Component<'shared.footer-menu-2', false>;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Layout: Schema.Attribute.DynamicZone<
      [
        'shared.home-banner',
        'shared.featured-course',
        'shared.courses-categories',
        'shared.innovation-and-accessibility',
        'shared.success-statistics-section',
        'shared.mentors-section',
        'shared.testimonials',
        'shared.latest-blog',
      ]
    >;
...
export interface ApiMentorMentor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Image: Schema.Attribute.Media<'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mentor.mentor'
